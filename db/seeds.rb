...
ishita=User.create(firstname: "Ishita", lastname: "Choudhary", dateofbirth: "01-13-1987", location_id: newdelhi.id, company: "Govt. of India", email: "ishita.a.choudhary@gmail.com", password: "abc123")
ash=User.create(firstname: "Ash", lastname: "Kenney", dateofbirth: "10-01-1987", location_id: evanston.id, company: "Kellogg School of Management", email: "ash2015@kellogg.northwestern.edu", password: "abc123")
nayab=User.create(firstname: "Nayab", lastname: "Khan", dateofbirth: "10-01-1987", location_id: jaipur.id, company: "Amazon", email: "nayab2015@kellogg.northwestern.edu", password: "abc123")
